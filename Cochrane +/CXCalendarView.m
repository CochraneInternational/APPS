...
//                      (id)[UIColor colorWithRed:125/255. green:150/255. blue:179/255. alpha:1].CGColor], NULL);
    ...
    self.monthBarBackgroundColor =[UIColor grayColor];
//    monthBarImage=[[UIImageView alloc] initWithFrame:_monthBar.frame];
//    [monthBarImage setImage:[UIImage imageNamed:@"bar.png"]];
//    [self addSubview:monthBarImage];
...
//    [monthBarImage setImage:[UIImage imageNamed:@"bar.png"]];
//    [self addSubview:monthBarImage];
    [self insertSubview:monthBarImage belowSubview:self.monthLabel];
...
//        monthBarImage=[[UIImageView alloc] initWithFrame:_monthBar.frame];
//        [monthBarImage setImage:[UIImage imageNamed:@"bar.png"]];
//        [_monthBar addSubview:monthBarImage];
