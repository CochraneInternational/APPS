...
- (void)updateDownloadProgress
{
    ...
    if(potato && [potato respondsToSelector:@selector(displayProgress::)])
    {
        ...
        [potato performSelector:@selector(displayProgress::) withObject:[NSNumber numberWithFloat:progressAmount] withObject:self];
    }
	#if NS_BLOCKS_AVAILABLE
    if (bytesReceivedBlock) {
